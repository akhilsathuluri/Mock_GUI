...
int main()
{
    ...
    try
    {
        ...
        std::cout << "          description:            " << pDevice->GetRemoteNode(sExposureNodeName)->GetDescription() << std::endl;
        std::cout << "          interface type:         " << pDevice->GetRemoteNode(sExposureNodeName)->GetInterface() << std::endl;
        ...
        std::cout << "          set value to:           " << std::fixed << std::setprecision(0) << pDevice->GetRemoteNode(sExposureNodeName)->GetDouble() << std::endl << std::endl;
        ...
        bo_int64 widthvalue = pDevice->GetRemoteNode("Height")->GetInt() / iImageWidthInc * iImageWidthInc; // find number to match the increment
        ...
        std::cout << "          set value to:           " << pDevice->GetRemoteNode("Width")->GetInt() << " is about same as the height: " << pDevice->GetRemoteNode("Height")->GetInt() << std::endl << std::endl;
        ...
        std::cout << "          description:            " << pDevice->GetRemoteNode("TriggerSource")->GetDescription() << std::endl;
        std::cout << "          interface type:         " << pDevice->GetRemoteNode("TriggerSource")->GetInterface() << std::endl;
        std::cout << "          enumeration list count: " << pDevice->GetRemoteNode("TriggerSource")->GetEnumNodeList()->GetNodeCount() << " (current marked with *)" << std::endl;
        ...
        std::cout << "          set value to:           " << pDevice->GetRemoteNode("TriggerSource")->GetValue() << std::endl << std::endl;

        //SET TRIGGER MODE ON
        std::cout << "        TriggerMode" << std::endl;
        std::cout << "          description:            " << pDevice->GetRemoteNode("TriggerMode")->GetDescription() << std::endl;
        std::cout << "          interface type:         " << pDevice->GetRemoteNode("TriggerMode")->GetInterface() << std::endl;
        std::cout << "          current value:          " << pDevice->GetRemoteNode("TriggerMode")->GetValue() << std::endl;
        pDevice->GetRemoteNode("TriggerMode")->SetString("On");
        std::cout << "          set value to:           " << pDevice->GetRemoteNode("TriggerMode")->GetValue() << std::endl << std::endl;
        ...
        if(IsAvailableLineInverter == true)
        {
            ...
            pDevice->GetRemoteNode("LineSelector")->SetString("Line0"); // LineSelector is interface type IEnumeration, see example TriggerSource

            std::cout << "5.3.5   LineInverter" << std::endl;
            std::cout << "          description:            " << pDevice->GetRemoteNode("LineInverter")->GetDescription() << std::endl;
            std::cout << "          interface type:         " << pDevice->GetRemoteNode("LineInverter")->GetInterface() << std::endl;
            std::cout << "          current value:          " << pDevice->GetRemoteNode("LineInverter")->GetBool() << std::endl;
            std::cout << "          Line0 LineStatus:       " << pDevice->GetRemoteNode("LineStatus")->GetBool() << std::endl << std::endl;

            //set LineInverter of Line0 to true
            pDevice->GetRemoteNode("LineInverter")->SetBool(true);

            //recheck new value
            std::cout << "          set value to:           " << pDevice->GetRemoteNode("LineInverter")->GetBool() << std::endl;
            std::cout << "          Line0 LineStatus:       " << pDevice->GetRemoteNode("LineStatus")->GetBool() << std::endl << std::endl;
        }
    }
    catch (BGAPI2::Exceptions::IException& ex)
    ...
    try
    {
        ...
        std::cout << "          description:            " << pDevice->GetRemoteNode("DeviceUserID")->GetDescription() << std::endl;
        std::cout << "          interface type:         " << pDevice->GetRemoteNode("DeviceUserID")->GetInterface() << std::endl;
        std::cout << "          current value:          " << pDevice->GetRemoteNode("DeviceUserID")->GetString() << std::endl;
        ...
        {
            std::cout << "Error: newDeviceUserID string length (" << newDeviceUserID.size() << ") is longer than MaxStringthLength (" << pDevice->GetRemoteNode("DeviceUserID")->GetMaxStringLength() << ")" << std::endl;
        }

        //RECHECK CHANGES
        std::cout << "          set value to:           " << pDevice->GetRemoteNode("DeviceUserID")->GetString() << std::endl;

        //RESET USER ID
        pDevice->GetRemoteNode("DeviceUserID")->SetString(oldDeviceUserID);
        std::cout << "          reset value to:         " << pDevice->GetRemoteNode("DeviceUserID")->GetString() << std::endl;
        std::cout << std::endl;
    }
    catch (BGAPI2::Exceptions::IException& ex)
    {
    ...
    try
    {
        for(int i = 0; i < 10; i++)
        {
            ...
            //SOFTWARE TRIGGER
            std::cout << " Execute TriggerSoftware " << i+1 << " is interface type " << pDevice->GetRemoteNode("TriggerSoftware")->GetInterface() << std::endl;
