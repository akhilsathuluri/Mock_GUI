            ...
            else
            {
                ...
                if (bImageSaved == false)
                {
                    try
                    {
                        ...
                        BGAPI2::Image* pImage = pImageProcessor->CreateImage((bo_uint)pBufferFilled->GetWidth(), (bo_uint)(pBufferFilled->GetHeight())
                            , pBufferFilled->GetPixelFormat(), (char*)pBuffer + uOffset, uBufferSize - uOffset);
