...
//------------------------------------------------------------------------------
BGAPI2::Node* GetFeature(BGAPI2::NodeMap* const pNodeMap, String feature)
{
    if (pNodeMap != NULL)
    {
        try
...
bool GetDeviceColorMatrix(BGAPI2::Device* const pDevice, double dColorMatrix[9])
{
    ...
    try
    {
        ...
        BGAPI2::Node* const pColorTransformationValueSelector = GetFeature(pNodeMap, SFNC_COLORTRANSFORMATIONVALUESELECTOR);
...
int Test()
{
    ...
    try
    {
        ...
        std::cout << "         TriggerMode:             " << pDevice->GetRemoteNode(SFNC_TRIGGERMODE)->GetValue() << std::endl;
        std::cout << std::endl;
    }
    catch (BGAPI2::Exceptions::IException& ex)
    {
    ...
    BGAPI2::Node* const pColorTransformationFactoryListSelector = GetFeature(pDeviceRemoteMap, "ColorTransformationFactoryListSelector");
    if (pColorTransformationFactoryListSelector)
    {
        ...
        BGAPI2::Node* const pColorTransformationResetToFactoryList = GetFeature(pDeviceRemoteMap, "ColorTransformationResetToFactoryList");
        if (pColorTransformationResetToFactoryList)
        {
            ...
            {
                pColorTransformationFactoryListSelector->SetString(pColorTransformationMap->GetNodeByIndex(iMatrixIndex)->GetValue());
    ...
    if (GetDeviceColorMatrix(pDevice, dColorMatrix))
    {
        ...
        std::cout << std::setw(6) << dColorMatrix[0] << " " << std::setw(6) << dColorMatrix[1] << " " << std::setw(6) << dColorMatrix[2] << std::endl;
        std::cout << std::setw(6) << dColorMatrix[3] << " " << std::setw(6) << dColorMatrix[4] << " " << std::setw(6) << dColorMatrix[5] << std::endl;
        std::cout << std::setw(6) << dColorMatrix[6] << " " << std::setw(6) << dColorMatrix[7] << " " << std::setw(6) << dColorMatrix[8] << std::endl;
