    ...
    try
    {
        ...
        if (pDevice->IsUpdateModeActive())
        {
            ...
            for (int i = 0; i < iTargetNumber; i++)
            {
                ...
                std::cout << "        Targetname:                       " << std::setw(2) << i << ":    " << pDevice->GetUpdateNode("TargetName")->GetValue() << std::endl;
            }
        ...
        try {
            ...
            if (bPerformUpdate)
            {
                ...
                else
                {
                    ...
                    std::cout << "Open of '" << sUpdatePath << "' was not possible - Update will be skipped!" << std::endl;
                }
            }
        }
        catch (BGAPI2::Exceptions::IException& ex)
