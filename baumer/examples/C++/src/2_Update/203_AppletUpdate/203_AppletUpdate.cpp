    ...
    try
    {
        ...
        if (pDevice->IsUpdateModeActive())
        {
            ...
            for (int i = 0; i < iAppletNumber; i++)
            {
                ...
                std::cout << "        AppletName:             [index " << std::setw(2) << i << "]:   " << pDevice->GetUpdateNode("AppletName")->GetValue() << std::endl;
            }
        ...
        try
        {
            ...
            if (pDevice->IsUpdateModeActive())
            {
                if (pDevice->GetUpdateNode("AppletSelector")->GetAvailable())
                {
                    ...
                    std::cout << "    Selected Device Applet:    " << pDevice->GetUpdateNode("AppletName")->GetValue() << std::endl;
                }
